from sqlalchemy import Column, Integer, Date, Numeric, Enum, Text, DateTime, ForeignKey
...
class Reservation(Base):
    ...
    status = Column(Enum("confirmed", "checked_in", "checked_out", "cancelled"), default="confirmed")
